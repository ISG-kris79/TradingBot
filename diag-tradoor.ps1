...
Write-Host "=========================================================="
Write-Host "  TRADOORUSDT recent entries (last 6h)"
Write-Host "=========================================================="
$cm = $cn.CreateCommand()
$cm.CommandTimeout = 30
$cm.CommandText = "SELECT TOP 5 * FROM TradeLogs WHERE Symbol LIKE 'TRADOOR%' AND [Time] >= DATEADD(HOUR, -6, GETUTCDATE()) ORDER BY [Time] DESC"
