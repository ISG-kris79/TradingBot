...
v2.0.23 기준 주요 수정사항 중 **4개는 바이비트 호환**, **1개는 바이낸스 전용**입니다.
...
**v2.0.23의 5가지 수정사항 중 4개는 바이비트에서 정상 작동하나, PUMP 전략 타임아웃 최적화는 바이낸스 전용 코드이므로 바이비트에서는 비호환입니다.**
