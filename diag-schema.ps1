...
$cm = $cn.CreateCommand(); $cm.CommandText = "SELECT TOP 0 * FROM TradeHistory"
$ap = New-Object System.Data.SqlClient.SqlDataAdapter $cm; $dt = New-Object System.Data.DataTable; [void]$ap.Fill($dt)
[Console]::OutputEncoding = [System.Text.Encoding]::UTF8
Write-Host "=== TradeHistory 컬럼 ===" -ForegroundColor Cyan
$dt.Columns | ForEach-Object { "$($_.ColumnName) [$($_.DataType.Name)]" }
$cn.Close()
